...
user110 = User.create!(
  username: "ZeynepTest",
  email: "zeynep@fish.com",
  password: "123456"
)

user210 = User.create!(
  username: "ZeynepTest2",
  email: "abc@fish.com",
  password: "123456"
)

fish = user210.fish.create!(
  name: "TestFish",
  fish_description: "somefish",
  color: "Blue",
  length: 12.5,
  sex: "Female",
  latitude: 41.0,
...
puts "- fish: #{Fish.count}"
puts "- Match: #{Match.count}"
puts "- URL test test: /fish/#{fish.id}/matches/#{match.id}/reviews/new"
